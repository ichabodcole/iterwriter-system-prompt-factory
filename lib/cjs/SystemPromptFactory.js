...
exports.SystemPromptFactory = void 0;
const scaledProperties_1 = require("./constants/scaledProperties");
class SystemPromptFactory {
    ...
    scaledPropertiesToString(scaledPropertiesConfig) {
        return Object.entries(scaledPropertiesConfig).reduce((acc, [key, value]) => {
            acc += `- ${scaledProperties_1.scaledProperties[key](value)}\n`;
            return acc;
        }, '');
    }
...
exports.SystemPromptFactory = SystemPromptFactory;
