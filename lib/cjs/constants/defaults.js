...
const scaledProperties_1 = require("./scaledProperties");
...
const createSystemPromptConfig = (overrides) => {
    return Object.assign({ context: exports.DEFAULT_CONTEXT, goal: (0, exports.createGoal)(), rules: (0, exports.createRules)(), writingStyle: {
            scaledProperties: exports.SCALED_PROPERTY_LIST.map((property) => scaledProperties_1.scaledProperties[property](exports.DEFAULT_PROPERTY_LEVEL))
        } }, overrides);
};
